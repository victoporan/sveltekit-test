<script>
  ...
  let products = [
    { id: 1, name: "Crystall Summer Earrings", image: "/images/summer-earrings-3.jpg", price: "$39", wished: false },
    ...
    { id: 8, name: "Crystall Earrings", image: "/images/summer-earrings-1.jpg", price: "$29", wished: false }
  ];
